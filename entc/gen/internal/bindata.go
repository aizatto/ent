...
func templateInternalTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/internal.tmpl", size: 462, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
